...
Google Chrome版本安装插件时，提示错误Apps, Extensions and scripts cannot be added from this website.为了推行谷歌的扩展商店的限制。使用如下命令启动即可顺利安装插件：

\begin{lstlisting}[language=Bash]
google-chrome --enable-easy-off-store-extension-install
# 顺昌顺畅安装插件，需要加上enable-easy-off-store-extension-install参数
