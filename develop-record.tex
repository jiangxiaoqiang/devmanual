...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.3]{wiresharkcaptureping.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.6]{fonttexgyrecursor.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.3]{linuxkillprocess.jpg}
	\caption{内存不足时自动结束进程}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.5]{toomayfiles.png}
...
在Intellij Idea调试Scala时，无法查看Scala的Vector等变量，提示Unable to evaluate the expression UnsupportedOperationException。解决方案是，重新安装Intellij Idea:
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.3]{intellijideaaddlibraries.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.35]{intellijideapluginxmltips.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.3]{autowiredcheckerror.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.4]{intellijideasqltips.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.35]{wiresharkcapturegradlerequest.jpg}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.3]{zealsearch}
	\caption{Zeal文档搜索示例}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.3]{tencententerprisemailbox.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.35]{gradleuserhome.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.35]{jenkinsbuildidsetting.jpg}
	\caption{Jeknins全局变量}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.5]{nginxgetrealip.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.4]{nginxreactconfig.jpg}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.3]{gitdiffusingmeldtool.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.7]{chromeasyncdebugging.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.2]{chromeperformancegraph.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.3]{wiresharkcapturecurlrequest.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.6]{webpackcheckingfilesize.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.35]{scriptusingdiskcache.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.4]{openservercompress.png}
	\caption{开启服务端压缩效果}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.5]{longtimerequest.png}
	\caption{耗时长的请求}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.35]{route-table.jpg}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.35]{allsystemcookies.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.35]{traceloginusercookie.png}
