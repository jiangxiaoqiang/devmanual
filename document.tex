...
curl 'http://creditsystem.test/pubapi/global/globalInfo' -H 'Pragma: no-cache' -H 'HL-APP-KEY: CreditChongqingSharePortal' -H 'DNT: 1' -H 'Accept-Encoding: gzip, deflate, sdch' -H 'Accept-Language: zh-CN,zh;q=0.8,en;q=0.6,zh-TW;q=0.4' -H 'User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36' -H 'Accept: application/json, text/plain, */*' -H 'Cache-Control: no-cache' -H 'HL-CURRENT-URL: http://creditsystem.test/main/about' -H 'Referer: http://creditsystem.test/main/about' -H 'Cookie: JSESSIONID=511E90813072BBF7167A3019C4CB8260' -H 'Connection: keep-alive' --compressed
...
\subsection{mycli}
周计划（2017-05-22到2017-05-26）


报表打印效率问题	任毅、王灿	100%	请在周二下班之前完成
日志统计修改	邵宇、钟祥云	100%	周二下班之前完成
红黑名单批量查询返回问题	王灿、任毅	100%	
添加USB Key登录后，无法查看报表	蒋小强	100%	周一下班前完成

周总结（2017-05-15到2017-05-19）

事中做好程序上做权限控制（密码试错容限）	任毅	100%	
核查审计管理、日志管理响应慢和无法查出内容，搜索条件添加日期段	王灿、任毅	100%	
用户登录、用户退出、增加用户、修改用户（要加上登录日志）	任毅	100%	
落实tongweb对用户资源的控制	蒋小强	100%	
根据日期查询给出单位和接口名和调用次数的报表	蒋小强	90%	暂未部署到测试环境
栏目未订阅时给予提示	王灿	100%	
添加USB Key登录后，无法查看报表	蒋小强	未开始	
信源部门工作台、USB Key认证、联合惩戒管理交给测试，并发布版本	蒋小强	100%	
自然人、企业查询报表打印慢	王灿、任毅	60%	
红黑名单批量查询“未查询到数据”显示、全选框逻辑问题	王灿	100%	
“信用重庆”新增红黑名单接口	蒋小强	100%	
联合惩戒管理问题的处理（过滤市级部门、查询条件无效等）	钟祥云	100%	
在线填报，报送统计中添加入库量列	邵宇、钟祥云	100%	
工作绩效报表自动登陆	钟祥云	100%
